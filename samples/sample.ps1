# Sample from https://github.com/Azure/azure-docs-powershell-samples/blob/master/load-balancer/load-balance-multiple-web-sites-vm/load-balance-multiple-web-sites-vm.ps1
